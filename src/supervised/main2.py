...
#calculate features for the friend and stranger pairs of the training set from the embeddings generated by main.py
make_5_trainfiles(gender, DATAPATH)


#calculate features for "regular" candidate pairs as generated by main.py file
...
#calculate features for "FAIR" candidate pairs as generated by main.py file
